...
df_train = pd.read_csv("drive/Quora_Questions_Pairs/train.csv")
df_test = pd.read_csv("drive/Quora_Questions_Pairs/test.csv")

print("Average Ensembling...")
df = pd.read_csv("drive/Quora_Questions_Pairs/preds0.csv")
for i in range(1, NUM_MODELS):
    df["is_duplicate"] = df["is_duplicate"] + pd.read_csv("drive/Quora_Questions_Pairs/preds" + str(i) + ".csv")["is_duplicate"]
...
submission.to_csv("drive/Quora_Questions_Pairs/submission.csv", index=False)
