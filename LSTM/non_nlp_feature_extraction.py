...
train_df = pd.read_csv("drive/Quora_Questions_Pairs/train.csv")
test_df = pd.read_csv("drive/Quora_Questions_Pairs/test.csv")
...
train_df.loc[:, cols].to_csv("drive/Quora_Questions_Pairs/non_nlp_features_train.csv", index=False)
test_df.loc[:, cols].to_csv("drive/Quora_Questions_Pairs/non_nlp_features_test.csv", index=False)
